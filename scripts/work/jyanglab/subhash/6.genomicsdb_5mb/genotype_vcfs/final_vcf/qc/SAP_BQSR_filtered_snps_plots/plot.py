...
#   plot-vcfstats -p /work/jyanglab/subhash/6.genomicsdb_5mb/genotype_vcfs/final_vcf/qc/SAP_BQSR_filtered_snps_plots /work/jyanglab/subhash/6.genomicsdb_5mb/genotype_vcfs/final_vcf/qc/SAP_BQSR_filtered_snps.stats.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. SAP_B .. /work/jyanglab/subhash/6.genomicsdb_5mb/genotype_vcfs/final_vcf/results/SAP_BQSR_filtered_snps.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='SAP_B')
    has_data = 1
